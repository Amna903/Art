    ...
    <main className="max-w-container-max mx-auto px-gutter-page py-16 md:py-24">
      <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <h1 className="font-display-lg text-display-lg text-primary">The Atlas, in Full.</h1>
        ...
        <Link
          href="/"
          className="font-navigation text-navigation uppercase tracking-widest text-on-surface-variant hover:text-secondary shrink-0"
        >
          ← Back to Home
        </Link>
      </header>
